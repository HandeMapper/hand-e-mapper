...
import project.recognition.skin.SkinRecognizer;
import project.recognition.skin.YCrCbSkinDetector;
...
public class HandRecognizer extends AbstractGesture {
	...
	*/
	...
	private final SkinRecognizer skinRec =
			//new project.recognition.skin.ForeheadHistogramRecognizer();
			new project.recognition.skin.FixedRangeRecognizer();
			//new project.recognition.skin.PointsOfInterestRecognizer();
